...
// $('.ks-navbar-menu').removeClass('ks-open');
// $('.ks-navbar-menu-toggle').click(function(){
	// if($('.ks-navbar-menu').hasClass('ks-open')){
		// $('.ks-navbar-menu').removeClass('ks-open');
	// }else{
		// $('.ks-navbar-menu').addClass('ks-open');
	// }
	// $('.ks-navbar-menu-toggle').toggleClass('ks-open');
// });

// $('.ks-navbar-actions-toggle').click(function(){
	// if($('.ks-navbar-actions').hasClass('ks-open')){
		// $('.ks-navbar-actions').removeClass('ks-open');
	// }else{
		// $('.ks-navbar-actions').addClass('ks-open');
	// }
	// $('.ks-navbar-actions-toggle').toggleClass('ks-open');
// });
